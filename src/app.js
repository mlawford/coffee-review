  ...
  attachEventListeners(){
    ...
    document.addEventListener('click', function(event){
      ...
      if (target.className === 'button2'){
        ...
        editNameInput.setAttribute('class', 'editform')
        ...
        editDrinkInput.setAttribute('class', 'editform')
        ...
        editPriceInput.setAttribute('class', 'editform')
        ...
        editRatingInput.setAttribute('class', 'editform')
